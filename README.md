...
...
Mounting com.mjr.test.StreamLambdaHandler::handleRequest (java8) at http://127.0.0.1:3000/{proxy+} [OPTIONS GET HEAD POST PUT DELETE PATCH]
...
```
    ...
    "Stacks": [
        {
            ...
            "Description": "AWS Serverless Spring API - com.mjr.test::my-service", 
            "Tags": [], 
            "Outputs": [
                {
